...
#     return [word for word in nlp(text).ents if word.text.lower() in symptom_set]

# # Load the dataset from CSV
# df = pd.read_csv(f'{ROOT_DIR}/data/pmc_patients/PMC-Patients-oa-9995.csv')

# # Assuming 'patient' column contains the medical records. If not, change this to the correct column name.
# df['extracted_symptoms'] = df['patient'].apply(lambda x: extract_symptoms(x))
